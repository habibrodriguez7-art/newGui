    ...
    function WindowObject:AddTab(tabConfig)
        ...
        function TabObject:AddSection(sectionTitle, isOpen)
            ...
            function SectionObject:AddParagraph(paragraphConfig)
                ...
                local listLayout = frame:FindFirstChildWhichIsA("UIListLayout")
                ...
                local function reflowParagraph()
                    ...
                    task.defer(function()
                        ...
                        task.defer(function()
                            if not frame or not frame.Parent then return end
                            if not listLayout or not listLayout.Parent then return end
                            frame.Size = UDim2.new(1, 0, 0, listLayout.AbsoluteContentSize.Y + 20)
                        end)
                    end)
                end
